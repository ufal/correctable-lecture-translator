...
from api.audio_handler import AudioBuffer
from api.common import ASRConfig, break_line, format_timestamp
from api.text_handlers import CurrentASRText
...
class ProcessingDataUnit:
    ...
    def get_data_to_offload(self) -> dict[str, str | int | list[bytes]] | None:
        """
