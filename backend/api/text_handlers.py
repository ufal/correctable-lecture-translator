...
class ASRTextUnit:
    def __init__(self, text: str, id_num: int, timespan: Timespan, version: int) -> None:
        self.text = text
        self.id_num = id_num
    ...
    def __str__(self) -> str:
        ...
        Example:
        >>> asr_text_unit = ASRTextUnit(text="This is some transcribed text.", id_num=0, timespan=Timespan(2, 3), version=0)
        >>> print(asr_text_unit)
    ...
    def from_json(self, json_str: str):
        res = jsonpickle.decode(json_str)
        assert type(res) == ASRTextUnit
        return res


class CurrentASRText:
    def __init__(self, save_path: str):
        self.text_chunks: dict[int, ASRTextUnit] = dict()
        self.text_chunks_no_spans: dict[int, ASRTextUnit] = dict()
